...
reported `fa=24` against a product that now does `fa=4`, and one of the two baseline
...
`fa=4 wa=13 missed=14 iot_ok=165 th=136`, prints why and **exits before a single
