...
/* The shipped index keeps the RSHIP_NEGBOUND negatives that most often sit on a
   positive exemplar's boundary and drops the rest: 10500 -> 3840 vectors,
   656 -> 240 KB.
   ...
   at th=136 a negative is never an IoT item's nearest neighbour. fa goes 1 -> 4
   of 1335 non-commands. The previous NN-coverage selection gave fa 6 at the same
   byte/runtime budget; boundary witnesses preserve more of the rejection surface.

   mkblob defaults to this and compare --ship reproduces it. */
#define RSHIP_NEGBOUND 2685
