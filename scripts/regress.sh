...
chk "runtime_choice_eval red-team passes 100/100" "$(c/bin/runtime_choice_eval --redteam 2>/dev/null | grep -c '^RUNTIME_CHOICE_EVAL_REDTEAM checks=89/89 score=100/100$')" "1"
