...
chk "runtime_choice_holdout red-team passes 100/100" "$(c/bin/runtime_choice_eval --holdout-redteam 2>/dev/null | grep -c '^RUNTIME_CHOICE_HOLDOUT_REDTEAM checks=63/63 score=100/100$')" "1"
